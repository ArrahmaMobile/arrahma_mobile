/**
 * Test script for tafseer2025 page scraping with UniversalCourseScraper
 */

import { HttpClient } from './core/http-client';
import { UniversalCourseScraper } from './scrapers/universal-scraper';

async function testUniversalTafseer() {
  console.log('🧪 Testing tafseer2025 with UniversalCourseScraper...\n');

  const httpClient = new HttpClient();

  const scraper = new UniversalCourseScraper(httpClient, 'https://arrahmah.org/tafseer2025/juz1.php');
...
testUniversalTafseer().catch(console.error);
